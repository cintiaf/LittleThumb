...
message(STATUS "beginner_tutorials: 0 messages, 2 services")
...
get_filename_component(_filename "/home/julien/catkin_ws/src/beginner_tutorials/srv/graphicClient.srv" NAME_WE)
add_custom_target(_beginner_tutorials_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "beginner_tutorials" "/home/julien/catkin_ws/src/beginner_tutorials/srv/graphicClient.srv" ""
)

get_filename_component(_filename "/home/julien/catkin_ws/src/beginner_tutorials/srv/javaClient.srv" NAME_WE)
add_custom_target(_beginner_tutorials_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "beginner_tutorials" "/home/julien/catkin_ws/src/beginner_tutorials/srv/javaClient.srv" ""
)
...
### Generating Services
_generate_srv_java(beginner_tutorials
  "/home/julien/catkin_ws/src/beginner_tutorials/srv/graphicClient.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/beginner_tutorials
)
_generate_srv_java(beginner_tutorials
  "/home/julien/catkin_ws/src/beginner_tutorials/srv/javaClient.srv"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_java(beginner_tutorials
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/beginner_tutorials
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(beginner_tutorials_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(beginner_tutorials_generate_messages beginner_tutorials_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/julien/catkin_ws/src/beginner_tutorials/srv/graphicClient.srv" NAME_WE)
add_dependencies(beginner_tutorials_generate_messages_java _beginner_tutorials_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/julien/catkin_ws/src/beginner_tutorials/srv/javaClient.srv" NAME_WE)
add_dependencies(beginner_tutorials_generate_messages_java _beginner_tutorials_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(beginner_tutorials_genjava)
add_dependencies(beginner_tutorials_genjava beginner_tutorials_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS beginner_tutorials_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/beginner_tutorials)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/beginner_tutorials
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
add_dependencies(beginner_tutorials_generate_messages_java std_msgs_generate_messages_java)
