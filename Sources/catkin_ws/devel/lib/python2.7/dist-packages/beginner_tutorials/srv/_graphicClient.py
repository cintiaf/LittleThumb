"""autogenerated by genpy from beginner_tutorials/graphicClientRequest.msg. Do not edit."""
import sys
...
class graphicClientRequest(genpy.Message):
  _md5sum = "4c173df295c85ab3371affc213cff7a8"
  _type = "beginner_tutorials/graphicClientRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(graphicClientRequest, self).__init__(*args, **kwds)
...
"""autogenerated by genpy from beginner_tutorials/graphicClientResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class graphicClientResponse(genpy.Message):
  _md5sum = "2522e220fa06fe7901e82fcde5a0bb66"
  _type = "beginner_tutorials/graphicClientResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(graphicClientResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.ret is None:
        self.ret = 0
    else:
...
class graphicClient(object):
  _type          = 'beginner_tutorials/graphicClient'
  _md5sum = 'a87438d98417569022b9a6dbef5e204c'
  _request_class  = graphicClientRequest
  _response_class = graphicClientResponse
