 ...
 */
public class TransformTangoDepthPublisher {
    ...
    public TransformTangoDepthPublisher(ConnectedNode connectedNode) {
    ...
    public void sendTransform(Transform transform) {
        ...
        mFrame = new FrameTransform(transform, FrameName.of("tango_device"), FrameName.of("tango_depth"), t);
    ...
    public void sendTransform(double v_x, double v_y, double v_z,
        ...
        mFrame = new FrameTransform(new Transform(vect, quat), FrameName.of("tango_device"), FrameName.of("tango_depth"), t);
