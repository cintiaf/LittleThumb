 ...
 */
public class TransformTangoSSPublisher {
    ...
    public TransformTangoSSPublisher(ConnectedNode connectedNode) {
    ...
    public void sendTransform(Transform transform) {
        ...
        mFrame = new FrameTransform(transform, FrameName.of("map"), FrameName.of("tango_ss"), t);
    ...
    public void sendTransform(double v_x, double v_y, double v_z,
        ...
        mFrame = new FrameTransform(new Transform(vect, quat), FrameName.of("map"), FrameName.of("tango_ss"), t);
